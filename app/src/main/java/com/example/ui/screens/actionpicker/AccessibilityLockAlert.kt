    ...
    AlertDialog(
        ...
        text = {
            Column(verticalArrangement = Arrangement.spacedBy(10.dp)) {
                Text(
                    "La acción '${type.displayName}' necesita que habilites el servicio de accesibilidad de Kinetix para simular gestos y botones del sistema de forma local.",
                    fontSize = 13.sp,
                    lineHeight = 18.sp
                )
